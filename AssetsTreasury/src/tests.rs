...
frame_support::construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		AssetsTreasury: assets_treasury::{Pallet, Call, Storage, Config, Event<T>},
	}
);
...
parameter_types! {
	...
	pub const AssetsTreasuryPalletId: PalletId = PalletId(*b"py/asttrsry");
}
...
impl Config for Test {
	type PalletId = AssetsTreasuryPalletId;
